...
public class BacklogDevelopment implements Serializable {
    ...
    @JoinColumn(name = "pic_PM", referencedColumnName = "id")
    private User pic_PM;

//    @JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
//    @ManyToMany(fetch = FetchType.LAZY)
//    @JoinColumn(name = "pic_Devs", referencedColumnName = "id")
//    private List<User> pic_Devs = new ArrayList<>();

    public BacklogDevelopment(){
    }

    public BacklogDevelopment(Long id, String created_by, Date created_date, String modify_by, Date modify_date, String application, String backlog_type, String backlog_code, String backlog_bpro, String backlog_desc, Date backlog_kickoff, String backlog_status, Date backlog_start, Date backlog_end, User pic_PM) {
        this.id = id;
    ...
    public User getPic_PM() {
        return pic_PM;
    }

    public void setPic_PM(User pic_PM) {
        this.pic_PM = pic_PM;
    }
}
